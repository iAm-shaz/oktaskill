    ...
    <div data-testid="refer-earn-page">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:flex justify-center">
              <div className="w-72 h-72 bg-okta-muted/20 rounded-2xl flex items-center justify-center border border-okta-muted/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} data-testid={`step-${item.step}`} className="text-center">
                <div className="w-14 h-14 mx-auto mb-4 bg-okta-gold/10 rounded-full flex items-center justify-center">
      ...
      <section className="bg-okta-primary py-12">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <Link
            to="/contact"
            data-testid="refer-bottom-cta-btn"
            className="inline-flex items-center gap-2 bg-okta-gold text-okta-primary font-montserrat font-bold text-sm px-8 py-3 rounded hover:brightness-110 transition-all"
          >
            Refer Now <ArrowRight size={16} />
          </Link>
